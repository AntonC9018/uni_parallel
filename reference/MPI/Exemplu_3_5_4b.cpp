...
2) se fixeaza o fateta a paralepipedului si se creaza un grup nou de procese care apartin muchiilor
   acestei fatete.
3)pentru grupul creat se construieste un comunicator cartizian de tip cerc (dimensiunea 1)
4) se realizeaza transmiterea datelor intre aceste procese
*/
#include <mpi.h>
#include <stdio.h>
#include <iostream>
...
/*
[Hancu_B_S@hpc Notate_Exemple]$ /opt/openmpi/bin/mpiCC -o Exemplu_3_5_4_new1.exe Exemplu_3_5_4_new1.cpp
[Hancu_B_S@hpc Notate_Exemple]$ /opt/openmpi/bin/mpirun -n 6  -machinefile ~/nodes6 Exemplu_3_5_4_new1.exe
===== REZULTATUL PROGRAMULUI 'Exemplu_3_5_4_new1.exe' 
...
Sunt procesul cu rankul 4 (2,0,0) vecinii mei sunt: 
   pe directia axei Y : stanga -2(-1,-1,-1) dreapta 5(2,1,0) 
...
Sunt procesul cu rankul 5 (2,1,0) vecinii mei sunt: 
   pe directia axei Y : stanga 4(2,0,0) dreapta -2(-1,-1,-1) 
   pe directia axei Z : jos -2(-1,-1,-1) sus -2(-1,-1,-1) 
[Hancu_B_S@hpc Notate_Exemple]$ 
[Hancu_B_S@hpc Notate_Exemple]$ /opt/openmpi/bin/mpirun -n 8  -machinefile ~/nodes6 Exemplu_3_5_4_new1.exe
